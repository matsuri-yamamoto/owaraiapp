...
//    }
    ...
    @objc func cellComedianNameData() {
        ...
        self.db.collection("new_contents").order(by: "display_number", descending: false).getDocuments() { (querySnapshot, err) in
            ...
            if let err = err {
                ...
                print("secondtab_comedianIdArray:\(comedianIdArray)")
