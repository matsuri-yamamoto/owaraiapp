...
class SecondTabViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    //    var comedianIdArray1: [String] = ["シマウマフック_1","惹女香花_1","ビッグボンバーズ_1","ひかるぶんどき_1","ムラムラタムラ_1","ふねしぼり_1"]
    //    var comedianIdArray2: [String] = ["リボンズ_1","牛女_1","鳥山明・暗_1","ハニカムズ_1","まんたナイスミドル_1","シンクロニシティ_1"]
    ...
    override func viewDidLoad() {
        ...
        print("secondTabcellSize:\(cellSize)")
    ...
    func cellComedianNameData() {
        ...
        self.db.collection("second_tab_comedian_array").getDocuments() { (querySnapshot, err) in
